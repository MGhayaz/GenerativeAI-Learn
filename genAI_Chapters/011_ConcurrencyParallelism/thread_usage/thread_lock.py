...
# this situation is race case safe we secure it with lock
...
def produce():
    ...
    for _ in range (1000_000_00):
        with lock : # this make sure no thread can intervent at same time to modify memory o common address
            runner = runner+1
