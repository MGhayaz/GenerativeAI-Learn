...
def build_gemini_tools() -> list[types.Tool]: # it is made in place of tools_maps in order to cater many tools_function schemas 
    ...
    for tool_name, tool_definition in TOOL_MAP.items(): # gemini response tools schema jabtak unne name,tools.info bhar ke diya -means usku jabtak tools ku chalana hai, loop chalta
